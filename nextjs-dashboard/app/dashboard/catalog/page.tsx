...
export default async function Page(props: {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6">
      ...
      <p className="text-sm text-gray-500 mb-6">Browse through unique creations made by authenticated regional artisans.</p>

      {/* Interactive Inputs mapping straight to URL bar */}
      <FilterControls />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {products.map((product) => (
            <div key={product.id} className="group bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm flex flex-col justify-between">
              ...
              <div className="p-4 pt-0 border-t border-gray-100 flex items-center justify-between mt-4">
