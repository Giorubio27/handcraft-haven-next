...
// export default function CreateArtisanForm({ users }: { users: User[] }) {
//   const initialState: ArtisanState = { message: null, errors: {} };
//   const [state, formAction] = useActionState(createArtisan, initialState);

//   return (
//     <form action={formAction}>
//       <div className="rounded-md bg-gray-50 p-4 md:p-6">
//         {/* Link to User Account Selection */}
//         <div className="mb-4">
